...
def run_test_count_cosines_from():
    ...
    expected = 4
    answer = count_cosines_from(4, 7, -1)
    ...
    expected = 1
    answer = count_cosines_from(5, 7, 0.8)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(4, 8, 0.2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(4, 7, 0.7)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.422594  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 14)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.228218  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(20, 24)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
